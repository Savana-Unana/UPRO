...
const defaultImage = 'images/MissingNo.png';
        const shivrianList = [
            ...
            {id: 6, name: "Sacred Axail", image: "images/Axail.png", typings: "Water, Rock", paratypings: "", category: "Alt", artist: "Amo", credits: "Idea-Shane+Amo+",
            description: "", region: "Lake"},
...
function filterShivrian() {
    ...
    Array.from(cards).forEach((card, index) => {
        ...
        const isPlains = region.includes("plains") && category != ("Alt");
        const isOcean = region.includes("ocean") && category != ("Alt");
        const isCruise = region.includes("cruise") && category != ("Alt");
        const isLake = region.includes("lake") && category != ("Alt");
        const isForest = region.includes("forest") && category != ("Alt");
        const isDesert = region.includes("desert") && category != ("Alt");
        const isVolcano = region.includes("volcano") && category != ("Alt");
        const isRiver = region.includes("river") && category != ("Alt");
        const isSwamp = region.includes("swamp") && category != ("Alt");
        const isIceCaps = region.includes("icecaps") && category != ("Alt");
        const isMountainRange = region.includes("mountainrange") && category != ("Alt");
        const isShiverCo = region.includes("shiverco") && category != ("Alt");
        const isCave = region.includes("cave") && category != ("Alt");
        const isSecretArea = region.includes("secretarea") && category != ("Alt");
        const isCafe = region.includes("cafe") && category != ("Alt");
        const isSpookyFactory = region.includes("spookyfactory") && category != ("Alt");
        const isSpookyJungle = region.includes("spookyjungle") && category != ("Alt");
        const isFrozenWasteland = region.includes("frozenwasteland") && category != ("Alt");
        const isUnobtainable = region.includes("unobtainable") && category != ("Alt");

        const isPlainsAlt = region.includes("plains") && category == ("Alt");
        const isOceanAlt = region.includes("ocean") && category == ("Alt");
        const isCruiseAlt = region.includes("cruise") && category == ("Alt");
        const isLakeAlt = region.includes("lake") && category == ("Alt");
        const isForestAlt = region.includes("forest") && category == ("Alt");
        const isDesertAlt = region.includes("desert") && category == ("Alt");
        const isVolcanoAlt = region.includes("volcano") && category == ("Alt");
        const isRiverAlt = region.includes("river") && category == ("Alt");
        const isSwampAlt = region.includes("swamp") && category == ("Alt");
        const isIceCapsAlt = region.includes("icecaps") && category == ("Alt");
        const isMountainRangeAlt = region.includes("mountainrange") && category == ("Alt");
        const isShiverCoAlt = region.includes("shiverco") && category == ("Alt");
        const isCaveAlt = region.includes("cave") && category == ("Alt");
        const isSecretAreaAlt = region.includes("secretarea") && category == ("Alt");
        const isCafeAlt = region.includes("cafe") && category == ("Alt");
        const isSpookyFactoryAlt = region.includes("spookyfactory") && category == ("Alt");
        const isSpookyJungleAlt = region.includes("spookyjungle") && category == ("Alt");
        const isFrozenWastelandAlt = region.includes("frozenwasteland") && category == ("Alt");
        const isUnobtainableAlt = region.includes("unobtainable") && category == ("Alt");
