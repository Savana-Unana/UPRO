...
export default function CredtrixPage() {
  useEffect(() => {
    document.title = "Guys thats literally my idea"
    document.body.className = "animatrix-groups-page uprod-page"
  ...
  return (
    ...
    <h1>Order (Currently Unordered) + Help</h1>
    <div className="controls uprod-controls">
  ...
  <main id="uprodGrid" className="cat-grid" />
  <div id="detailsModal" className="modal hidden">
    <div className="modal-content">
      ...
      <div className="modal-body">
        ...
        <div id="mateCredits" className="uprod-credit-panels">
          <div id="conceptedByContainer" className="uprod-credit-card" />
          <div id="assistedByContainer" className="uprod-credit-card" />
          <div id="namedByContainer" className="uprod-credit-card" />
        </div>
