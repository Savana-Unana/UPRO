...
export default function GuessrPage() {
  useEffect(() => {
    document.title = "Guessr"
    document.body.className = "guessr-page"
  ...
  return (
    <>
      ...
      <div className="upro-page-root"><main className="guessr-shell">
    <header className="guessr-header">
      <a className="guessr-back-link" href="/normal">Back</a>
      <div className="guessr-logo-block">
        <img src="assets/images/ui/Logo.png" alt="UPRO logo" className="guessr-logo" />
        <div>
          <h1 className="guessr-title">Guessr</h1>
          <p className="guessr-subtitle" id="guessrModeLabel">Two daily clue hunts, two different animates</p>
        </div>
      </div>
      <div className="guessr-header-actions">
        <button className="guessr-random-btn" type="button" id="guessrRandomBtn" hidden>Play Random Round</button>
      </div>
    </header>
    <section className="guessr-tabs" id="guessrTabs" aria-label="Guessr clue modes" />
    <section className="guessr-stage" id="guessrGameGrid" />
  </main></div>
    </>
  )
}
